...
| `POSTGRES_PASSWORD`                  | Password for the Docker Compose Postgres service.                    | Docker Compose                    | none                                                       |
...
| `CLOUDFLARE_TUNNEL_TOKEN`            | Cloudflare Tunnel token exposing the daemon without public ports.    | Docker Compose                    | none                                                       |
| `SENTRY_DSN`                         | Optional error reporting DSN passed to VM services.                  | Docker Compose                    | none                                                       |
