  ...
  return (
    <section className="px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <StaggerContainer className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3" stagger={0.08}>
          {features.map((feature, index) => {
            const Icon = feature.icon;
            return (
              <AnimateIn key={feature.title} direction="up" distance={36} delay={index * 0.08}>
                <Card className="h-full transition duration-300 hover:-translate-y-1 hover:border-[var(--color-arc-purple)]/60 hover:shadow-[0_18px_60px_rgba(0,0,0,0.28)]">
                  <CardContent>
