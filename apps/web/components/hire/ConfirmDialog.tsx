...
export function ConfirmDialog({ open, onOpenChange, agentId, draft }: { open: boolean; onOpenChange: (open: boolean) => void; agentId: string; draft: HireDraft }) {
    ...
    <Modal.Root open={open} onOpenChange={onOpenChange}>
      <Modal.Content>
        ...
        <div className="mt-4 space-y-4 text-sm leading-7 text-[var(--color-text-secondary)]">
          <p>This creates and funds an Agora escrow for agent #{agentId}. Funds are released after delivery and mediator verification.</p>
          ...
          <HireSubmitButton agentId={agentId} draft={draft} />
