    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IEscrowManager.Escrow",
        "components": [
          {
            "name": "agentId",
            "type": "uint256",
